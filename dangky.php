...
<head>
  ...
  <style>
    ...
    .container {
      ...
      width: 360px; max-width: 90%; padding: 40px 30px; margin: 40px auto;
    }
    h2 { margin: 10px 0 5px; color: #00bfff; }
    p { font-size: 20px; color: #666; margin-bottom: 20px; }
    form { text-align: left; }
    label { display: block; font-size: 14px; margin-bottom: 5px; color: #333; }
    input[type="text"], input[type="email"], input[type="password"], input[type="tel"] {
      width: 100%; padding: 10px; margin-bottom: 15px;
      border-radius: 6px; border: 1px solid #ccc; box-sizing: border-box; font-size: 14px;
    }
    .checkbox { font-size: 12px; color: #555; display: flex; align-items: center; gap: 5px; margin-bottom: 15px; }
    .checkbox a { color: #00bfff; text-decoration: none; }
    .btn { width: 100%; padding: 10px; background-color: #00bfff; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 15px; margin-bottom: 15px; }
...
<body>
  <div class="container">
    <div class="logo"><img src="assets/logo_habitu.png" width="120" height="120" alt="Habitu Logo" class="logo-img" style="display:block; margin:0 auto;">
    <div class="header">
      <h2>Đăng Ký</h2>
    ...
    <form action="" method="POST">
      ...
      <input id="username" type="text" name="username" placeholder="Nhập tên của bạn" required value="<?= htmlspecialchars($username) ?>">

      <label for="email">Email</label>
      <input id="email" type="email" name="email" placeholder="your@email.com" required value="<?= htmlspecialchars($email) ?>">
      ...
      <div style="display: flex; gap: 20px; align-items: center; margin-bottom: 16px;">
        ...
        <label><input type="radio" name="gender" value="Khác" <?= ($gender=="Khác")?"checked":"" ?> required> Khác</label>
      </div>

      <label for="tel">Số điện thoại</label>
      <input id="tel" type="tel" name="tel" pattern="[0-9]{10}" placeholder="0123456789" required value="<?= htmlspecialchars($tel) ?>">
