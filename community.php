            ...
            <form method="post" action="community.php">
                ...
                <div class="flex items-center justify-between mt-3">
                    <div class="text-sm text-gray-500">
                        Đăng với tư cách: <span
                            class="font-semibold text-teal-700"><?= htmlspecialchars($username) ?></span>
                    </div>
                    <button
                        class="bg-teal-400 hover:bg-teal-500 text-white px-4 py-2 rounded-full flex items-center gap-2">
            ...
            <?php foreach ($posts as $p): ?>
                <div class="bg-white rounded-2xl shadow p-5 border border-teal-50">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div
                            class="w-12 h-12 bg-teal-100 rounded-full flex items-center justify-center text-xl text-teal-700 font-bold">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex justify-between items-start">
                                <div>
                                    ...
                                    <div class="text-xs text-gray-400"><?= date('H:i d/m/Y', strtotime($p['created_at'])) ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="comments-<?= $p['post_id'] ?>" class="mt-4 space-y-3 hidden">
                                    ...
                                    <?php foreach ($commentsByPost[$p['post_id']] as $c): ?>
                                        <div class="bg-gray-50 rounded-lg p-3">
                                            <div class="flex items-start gap-3">
                                                <div
                                                    class="w-8 h-8 bg-indigo-100 rounded-full flex items-center justify-center text-indigo-700 font-semibold text-sm">
                                ...
                                <form method="post" action="community.php" class="flex gap-3 items-start mt-2">
                                    ...
                                    <textarea name="comment_content" rows="1" class="flex-1 p-2 border rounded-lg"
