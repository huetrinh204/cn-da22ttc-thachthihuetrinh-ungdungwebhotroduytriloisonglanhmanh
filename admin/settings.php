...
<div class="px-10 py-5">
    <h1 class="text-3xl font-bold text-white" style="text-shadow: 2px 2px 6px rgba(0,0,0,0.5);">Cài Đặt Hệ Thống</h1>
    <p class="text-gray-700 mb-6">Quản lý cấu hình, thông tin ứng dụng và quyền truy cập</p>

    <!-- Section 1: Thông tin Admin -->
    <div class="bg-white shadow rounded-lg p-5 mb-6">
        <h2 class="text-xl font-semibold mb-3">Thông tin Admin</h2>
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="email" class="w-full border border-gray-300 px-3 py-2 rounded" placeholder="admin@example.com">
            </div>
            <div>
            ...
            <div class="flex items-end">
                <button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded shadow">Cập nhật</button>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white shadow rounded-lg p-5 mb-6">
        <h2 class="text-xl font-semibold mb-3">Cấu hình hệ thống</h2>
        <div class="flex flex-col gap-4">
            ...
            <button class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded shadow w-48">Lưu cài đặt</button>
        </div>
    </div>
    ...
    <div class="bg-white shadow rounded-lg p-5">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" class="w-full border border-gray-300 px-3 py-2 rounded" value="support@habitu.com">
            </div>
        </div>
    </div>
</div>
