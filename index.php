    ...
    <div class="bg-white rounded-2xl w-[90%] max-w-lg shadow-lg p-6 relative">
      ...
      <div class="mb-4">
        <div class="flex justify-between text-sm text-gray-500 mb-1">
          <span id="stepLabel">Bước 1 / 7</span>
        </div>
        <div class="h-1.5 bg-gray-200 rounded-full">
          <div id="progressBar" class="h-1.5 bg-teal-400 rounded-full w-1/6 transition-all duration-300"></div>
        </div>
      </div>
      ...
      <div class="flex justify-between items-center mt-4">
        <button id="prevBtn" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-600 hover:bg-gray-100">
          ← Quay Lại
        </button>
      ...
      <div class="flex justify-center mt-4 space-x-2">
        <div class="dot w-2.5 h-2.5 rounded-full bg-teal-400"></div>
        <div class="dot w-2.5 h-2.5 rounded-full bg-gray-300"></div>
        <div class="dot w-2.5 h-2.5 rounded-full bg-gray-300"></div>
        <div class="dot w-2.5 h-2.5 rounded-full bg-gray-300"></div>
        <div class="dot w-2.5 h-2.5 rounded-full bg-gray-300"></div>
        <div class="dot w-2.5 h-2.5 rounded-full bg-gray-300"></div>
